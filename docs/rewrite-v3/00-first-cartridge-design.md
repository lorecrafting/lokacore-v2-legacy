...
| Economy | one shop (chandler), inn food and drink, ferry fare, barter with Sedge | second shop (priory alms for potions), healer, trainers for the three guilds | armorer, apothecary, bank, haggle, faction pricing, liquidity and restock, stables, smithy jobs, mine quota, NPC-to-NPC trade, housing, mail |
...
| 3 | R8 economy and law additions; R16 factory assists content | mounts, barter (formalized), property, steal, law, mail, recognition, NPC commerce, track | roughly 5 to 8 months after chapter two | full mechanic set proven; third cartridge; campaign complete |
