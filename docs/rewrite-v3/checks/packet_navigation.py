...
DOCUMENTS = {
    ...
    '02-beam-runtime-architecture.md': ('Design contract: online host', 'Account/progress service arrives at R12A; gameplay hosting at R14. Review ownership and recovery without pulling shared-world work forward.'),
